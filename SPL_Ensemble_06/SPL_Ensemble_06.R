...
# Setting parameters
xgb.parms.default = expand.grid(nrounds = 400, max_depth = 10, eta = 0.05, gamma = 0, colsample_bytree = 1, 
    min_child_weight = 1, subsample = 0.6)

# Train Model
set.seed(123)
xgb.ensemble = caret::train(actual ~ ., data = trainset_ensemble, method = "xgbTree", tuneGrid = xgb.parms.default, 
